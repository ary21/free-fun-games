...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Register Games
  registerGame("memory", "Memory Cards", "🎴", "#FF6B6B", MemoryGame.init);
  ...
  registerGame("counting", "Counting", "1️⃣", "#9FA8DA", CountingGame.init);
  registerGame("space", "Space Explorer", "🪐", "#2D3436", SolarGame.init);
  ...
  registerGame(
    ...
    "🧩",
    "#96CEB4",
    (el) => (el.innerHTML = "<h2>Sliding Puzzle Placeholder</h2>")
  );
  registerGame(
    "maze",
    "Maze",
    "🗺️",
    "#D4A5A5",
    (el) => (el.innerHTML = "<h2>Maze Placeholder</h2>")
  );
  registerGame(
    "counting",
    "Counting",
    "1️⃣",
    "#9FA8DA",
    (el) => (el.innerHTML = "<h2>Counting Placeholder</h2>")
  );
  registerGame(
    "space",
    "Space Explorer",
    "🪐",
    "#2D3436",
    (el) => (el.innerHTML = "<h2>Space 3D Placeholder</h2>")
  );
